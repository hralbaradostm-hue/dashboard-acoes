...
def load_data():
    ...
    # --- FUNÇÃO INTELIGENTE DE LOGOTIPOS (HÍBRIDA COM FALLBACK) ---
    def obter_logo(ticker):
        t = str(ticker).upper().strip()
        # Mapeamento direto para as principais empresas da B3
        logos_map = {
            "PETR4": "https://s3-symbol-logo.tradingview.com/petrobras.svg",
            "PETR3": "https://s3-symbol-logo.tradingview.com/petrobras.svg",
            "VALE3": "https://s3-symbol-logo.tradingview.com/vale.svg",
            "ITUB4": "https://s3-symbol-logo.tradingview.com/itau-unibanco-holding.svg",
            "BBDC4": "https://s3-symbol-logo.tradingview.com/banco-bradesco.svg",
            "BBDC3": "https://s3-symbol-logo.tradingview.com/banco-bradesco.svg",
            "BBAS3": "https://s3-symbol-logo.tradingview.com/banco-do-brasil.svg",
            "ABEV3": "https://s3-symbol-logo.tradingview.com/ambev.svg",
            "WEGE3": "https://s3-symbol-logo.tradingview.com/weg.svg",
            "ITSA4": "https://s3-symbol-logo.tradingview.com/itausa.svg",
            "RENT3": "https://s3-symbol-logo.tradingview.com/localiza.svg",
            "B3SA3": "https://s3-symbol-logo.tradingview.com/b3.svg",
            "SUZB3": "https://s3-symbol-logo.tradingview.com/suzano.svg",
            "JBSS3": "https://s3-symbol-logo.tradingview.com/jbs.svg",
            "RADL3": "https://s3-symbol-logo.tradingview.com/raia-drogasil.svg"
        }
        if t in logos_map:
            return logos_map[t]
        
        # Ícone corporativo financeiro padrão para os demais ativos (evita células vazias)
        return "https://cdn-icons-png.flaticon.com/512/2454/2454282.png"
