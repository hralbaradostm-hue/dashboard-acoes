        ...
        with st.spinner(f"Buscando {rx_ticker} na Bolsai..."):
            ...
            try:
                ...
                if res.status_code == 200:
                  ...
                  # --- NOVO BLOCO: GRÁFICO DE 10 ANOS ---
                st.markdown("---")
                st.subheader(f"📈 Evolução de Preço (10 Anos) - {rx_ticker}")
                ...
                with st.spinner("Buscando histórico na bolsa..."):
                    try:
                        ...
                        # O período foi alterado de "1y" para "10y"
                        historico = acao_yf.history(period="10y")
